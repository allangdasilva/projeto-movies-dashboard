...
function MovieCard(){
    ...
    return (
        ...
        <section className="w-full min-h-screen flex flex-col gap-8 items-center justify-center p-8 lg:flex-row">
            ...
            <div className="w-full flex justify-center text-white">{movieVideo && (
                <iframe width="560" height="315" src={`https://www.youtube.com/embed/${movieVideo.key}`} title={`${movieVideo.name}`} frameBorder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" referrerPolicy="strict-origin-when-cross-origin" allowFullScreen
                className="w-full max-w-lg max-h-72 aspect-video shadow-md"></iframe>
            )}</div>
